...
ActiveRecord::Schema.define(version: 2021_07_29_155034) do
  ...
  create_table "join_stroll_with_dogs", force: :cascade do |t|
    t.integer "dog_id"
    t.integer "stroll_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dog_id"], name: "index_join_stroll_with_dogs_on_dog_id"
    t.index ["stroll_id"], name: "index_join_stroll_with_dogs_on_stroll_id"
  end
